...
| 
-------------------------------------------------------------------*/
	$config['attachment_path'] = '/event/explorerchallenge/upfiles/attachments';
/*-------------------------------------------------------------------
| 
...
| 
-------------------------------------------------------------------*/
	$config['allowed_attachment_types'] = 'csv';
/*-------------------------------------------------------------------
| 
...
-------------------------------------------------------------------*/
	...
	$config['attachment_upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['attachment_path'];
